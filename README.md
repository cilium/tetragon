...
Since version 0.8.4, all Tetragon images include a Software Bill of Materials (SBOM).
This SBOM is generated by [bom](https://github.com/kubernetes-sigs/bom). If you are new to the concept of SBOM, see [What an SBOM Can Do for You](https://www.chainguard.dev/unchained/what-an-sbom-can-do-for-you).
