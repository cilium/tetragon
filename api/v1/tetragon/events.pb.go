...
var file_tetragon_events_proto_rawDesc = []byte{
	...
	0x22, 0xe6, 0x04, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	...
	0x62, 0x65, 0x12, 0x26, 0x0a, 0x04, 0x74, 0x65, 0x73, 0x74, 0x18, 0xc0, 0xb8, 0x02, 0x20, 0x01,
	...
	0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2a, 0x9a, 0x01, 0x0a, 0x09, 0x45, 0x76,
	...
	0x53, 0x5f, 0x55, 0x50, 0x52, 0x4f, 0x42, 0x45, 0x10, 0x0c, 0x12, 0x0a, 0x0a, 0x04, 0x54, 0x45,
	0x53, 0x54, 0x10, 0xc0, 0xb8, 0x02, 0x2a, 0x2d, 0x0a, 0x11, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x46,
	...
	0x55, 0x44, 0x45, 0x10, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tetragon_events_proto_goTypes = []interface{}{
	...
	(*ProcessLoader)(nil),         // 15: tetragon.ProcessLoader
	(*ProcessUprobe)(nil),         // 16: tetragon.ProcessUprobe
	(*Test)(nil),                  // 17: tetragon.Test
...
var file_tetragon_events_proto_depIdxs = []int32{
	...
	15, // 15: tetragon.GetEventsResponse.process_loader:type_name -> tetragon.ProcessLoader
	16, // 16: tetragon.GetEventsResponse.process_uprobe:type_name -> tetragon.ProcessUprobe
	17, // 17: tetragon.GetEventsResponse.test:type_name -> tetragon.Test
	18, // 18: tetragon.GetEventsResponse.time:type_name -> google.protobuf.Timestamp
	6,  // 19: tetragon.GetEventsResponse.aggregation_info:type_name -> tetragon.AggregationInfo
