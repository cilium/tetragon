...
var file_tetragon_events_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x73, 0x22, 0x51, 0x0a, 0x0f, 0x52, 0x65, 0x64, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
...
var file_tetragon_events_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_tetragon_events_proto_goTypes = []interface{}{
	...
	(*RedactionFilter)(nil),       // 3: tetragon.RedactionFilter
	(*FieldFilter)(nil),           // 4: tetragon.FieldFilter
	(*GetEventsRequest)(nil),      // 5: tetragon.GetEventsRequest
	(*AggregationOptions)(nil),    // 6: tetragon.AggregationOptions
	(*AggregationInfo)(nil),       // 7: tetragon.AggregationInfo
	(*RateLimitInfo)(nil),         // 8: tetragon.RateLimitInfo
	(*GetEventsResponse)(nil),     // 9: tetragon.GetEventsResponse
	(*wrapperspb.BoolValue)(nil),  // 10: google.protobuf.BoolValue
	(*fieldmaskpb.FieldMask)(nil), // 11: google.protobuf.FieldMask
	(*durationpb.Duration)(nil),   // 12: google.protobuf.Duration
	(*ProcessExec)(nil),           // 13: tetragon.ProcessExec
	(*ProcessExit)(nil),           // 14: tetragon.ProcessExit
	(*ProcessKprobe)(nil),         // 15: tetragon.ProcessKprobe
	(*ProcessTracepoint)(nil),     // 16: tetragon.ProcessTracepoint
	(*ProcessLoader)(nil),         // 17: tetragon.ProcessLoader
	(*ProcessUprobe)(nil),         // 18: tetragon.ProcessUprobe
	(*Test)(nil),                  // 19: tetragon.Test
	(*timestamppb.Timestamp)(nil), // 20: google.protobuf.Timestamp
}
var file_tetragon_events_proto_depIdxs = []int32{
	10, // 0: tetragon.Filter.health_check:type_name -> google.protobuf.BoolValue
	0,  // 1: tetragon.Filter.event_set:type_name -> tetragon.EventType
	2,  // 2: tetragon.RedactionFilter.match:type_name -> tetragon.Filter
	0,  // 3: tetragon.FieldFilter.event_set:type_name -> tetragon.EventType
	11, // 4: tetragon.FieldFilter.fields:type_name -> google.protobuf.FieldMask
	1,  // 5: tetragon.FieldFilter.action:type_name -> tetragon.FieldFilterAction
	10, // 6: tetragon.FieldFilter.invert_event_set:type_name -> google.protobuf.BoolValue
	2,  // 7: tetragon.GetEventsRequest.allow_list:type_name -> tetragon.Filter
	2,  // 8: tetragon.GetEventsRequest.deny_list:type_name -> tetragon.Filter
	6,  // 9: tetragon.GetEventsRequest.aggregation_options:type_name -> tetragon.AggregationOptions
	4,  // 10: tetragon.GetEventsRequest.field_filters:type_name -> tetragon.FieldFilter
	12, // 11: tetragon.AggregationOptions.window_size:type_name -> google.protobuf.Duration
	13, // 12: tetragon.GetEventsResponse.process_exec:type_name -> tetragon.ProcessExec
	14, // 13: tetragon.GetEventsResponse.process_exit:type_name -> tetragon.ProcessExit
	15, // 14: tetragon.GetEventsResponse.process_kprobe:type_name -> tetragon.ProcessKprobe
	16, // 15: tetragon.GetEventsResponse.process_tracepoint:type_name -> tetragon.ProcessTracepoint
	17, // 16: tetragon.GetEventsResponse.process_loader:type_name -> tetragon.ProcessLoader
	18, // 17: tetragon.GetEventsResponse.process_uprobe:type_name -> tetragon.ProcessUprobe
	19, // 18: tetragon.GetEventsResponse.test:type_name -> tetragon.Test
	8,  // 19: tetragon.GetEventsResponse.rate_limit_info:type_name -> tetragon.RateLimitInfo
	20, // 20: tetragon.GetEventsResponse.time:type_name -> google.protobuf.Timestamp
	7,  // 21: tetragon.GetEventsResponse.aggregation_info:type_name -> tetragon.AggregationInfo
...
func file_tetragon_events_proto_init() {
	...
	file_tetragon_events_proto_msgTypes[7].OneofWrappers = []interface{}{
