...
type TracingPolicyDomain int32

const (
	// unknown tracing policy domain (unset)
	TracingPolicyDomain_TP_DOMAIN_UNKNOWN TracingPolicyDomain = 0
	// statically loaded tracing policies
	TracingPolicyDomain_TP_DOMAIN_STATIC TracingPolicyDomain = 1
	// tracing policies loaded via gRPC
	TracingPolicyDomain_TP_DOMAIN_GRPC TracingPolicyDomain = 2
	// tracing policies loaded via k8s
	TracingPolicyDomain_TP_DOMAIN_K8S TracingPolicyDomain = 3
)

// Enum value maps for TracingPolicyDomain.
var (
	TracingPolicyDomain_name = map[int32]string{
		0: "TP_DOMAIN_UNKNOWN",
		1: "TP_DOMAIN_STATIC",
		2: "TP_DOMAIN_GRPC",
		3: "TP_DOMAIN_K8S",
	}
	TracingPolicyDomain_value = map[string]int32{
		"TP_DOMAIN_UNKNOWN": 0,
		"TP_DOMAIN_STATIC":  1,
		"TP_DOMAIN_GRPC":    2,
		"TP_DOMAIN_K8S":     3,
...
func (x TracingPolicyDomain) Enum() *TracingPolicyDomain {
	p := new(TracingPolicyDomain)
	*p = x
	return p
}

func (x TracingPolicyDomain) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TracingPolicyDomain) Descriptor() protoreflect.EnumDescriptor {
	return file_tetragon_sensors_proto_enumTypes[0].Descriptor()
}

func (TracingPolicyDomain) Type() protoreflect.EnumType {
	return &file_tetragon_sensors_proto_enumTypes[0]
}

func (x TracingPolicyDomain) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TracingPolicyDomain.Descriptor instead.
func (TracingPolicyDomain) EnumDescriptor() ([]byte, []int) {
...
type ListTracingPoliciesRequest struct {
	...
	Domain        TracingPolicyDomain `protobuf:"varint,1,opt,name=domain,proto3,enum=tetragon.TracingPolicyDomain" json:"domain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListTracingPoliciesRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
}
...
type TracingPolicyStatus struct {
	...
	Domain        TracingPolicyDomain `protobuf:"varint,13,opt,name=domain,proto3,enum=tetragon.TracingPolicyDomain" json:"domain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TracingPolicyStatus) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
type AddTracingPolicyRequest struct {
	...
	Domain        TracingPolicyDomain    `protobuf:"varint,2,opt,name=domain,proto3,enum=tetragon.TracingPolicyDomain" json:"domain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AddTracingPolicyRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
type DeleteTracingPolicyRequest struct {
	...
	Domain        TracingPolicyDomain    `protobuf:"varint,3,opt,name=domain,proto3,enum=tetragon.TracingPolicyDomain" json:"domain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeleteTracingPolicyRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
func (x *EnableTracingPolicyRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
func (x *DisableTracingPolicyRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
type ConfigureTracingPolicyRequest struct {
	...
	Domain        TracingPolicyDomain    `protobuf:"varint,5,opt,name=domain,proto3,enum=tetragon.TracingPolicyDomain" json:"domain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConfigureTracingPolicyRequest) GetDomain() TracingPolicyDomain {
	if x != nil {
		return x.Domain
	}
	return TracingPolicyDomain_TP_DOMAIN_UNKNOWN
...
type ListDomainsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Domains       []TracingPolicyDomain  `protobuf:"varint,1,rep,packed,name=domains,proto3,enum=tetragon.TracingPolicyDomain" json:"domains,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListDomainsResponse) GetDomains() []TracingPolicyDomain {
	if x != nil {
		return x.Domains
	}
	return nil
...
var file_tetragon_sensors_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x69, 0x63, 0x69, 0x65, 0x73, 0x22, 0x64, 0x0a, 0x17, 0x41, 0x64, 0x64, 0x54, 0x72, 0x61, 0x63,
	...
	0x79, 0x61, 0x6d, 0x6c, 0x12, 0x35, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e,
	0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x44, 0x6f, 0x6d,
	0x61, 0x69, 0x6e, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x1a, 0x0a, 0x18, 0x41,
	0x64, 0x64, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x1a, 0x44, 0x65, 0x6c, 0x65,
	...
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x35, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61,
	0x69, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61,
	0x67, 0x6f, 0x6e, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22,
	0x1d, 0x0a, 0x1b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x85,
	0x01, 0x0a, 0x1a, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67,
	...
	0x35, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x1d, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x69,
	0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x06,
	0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x1d, 0x0a, 0x1b, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x86, 0x01, 0x0a, 0x1b, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c,
	...
	,
	...
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x14, 0x0a,
	0x12, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x4e, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x6f, 0x6d, 0x61, 0x69,
	0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x64, 0x6f,
	0x6d, 0x61, 0x69, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x74, 0x65,
	0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x07, 0x64, 0x6f, 0x6d, 0x61,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5b, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x54,
	0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x21, 0x2e, 0x74,
	...
	0x22, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x41, 0x64, 0x64, 0x54, 0x72,
	0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x64, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54,
	...
	,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e,
	...
	0x12, 0x67, 0x0a, 0x13, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x88, 0x02, 0x01, 0x12, 0x6a, 0x0a, 0x14, 0x44, 0x69, 0x73,
	0x61, 0x62, 0x6c, 0x65, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x12, 0x25, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x44, 0x69, 0x73,
	0x61, 0x62, 0x6c, 0x65, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61,
	...
	0x22, 0x03, 0x88, 0x02, 0x01, 0x12, 0x4f, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x6e,
	...
	0x22, 0x03, 0x88, 0x02, 0x01, 0x12, 0x4c, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x6f, 0x6d,
	0x61, 0x69, 0x6e, 0x73, 0x12, 0x1c, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e,
	...
	0x65, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x1b, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x47, 0x65, 0x74,
	...
	0x0a, 0x07, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x18, 0x2e, 0x74, 0x65, 0x74, 0x72,
	0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x47,
	...
	,
...
var file_tetragon_sensors_proto_goTypes = []any{
	(TracingPolicyDomain)(0),               // 0: tetragon.TracingPolicyDomain
	(TracingPolicyState)(0),                // 1: tetragon.TracingPolicyState
	(TracingPolicyMode)(0),                 // 2: tetragon.TracingPolicyMode
...
var file_tetragon_sensors_proto_depIdxs = []int32{
	...
	0,  // 1: tetragon.ListTracingPoliciesRequest.domain:type_name -> tetragon.TracingPolicyDomain
	9,  // 2: tetragon.TracingPolicyStats.action_counters:type_name -> tetragon.TracingPolicyActionCounters
	1,  // 3: tetragon.TracingPolicyStatus.state:type_name -> tetragon.TracingPolicyState
	2,  // 4: tetragon.TracingPolicyStatus.mode:type_name -> tetragon.TracingPolicyMode
	10, // 5: tetragon.TracingPolicyStatus.stats:type_name -> tetragon.TracingPolicyStats
	0,  // 6: tetragon.TracingPolicyStatus.domain:type_name -> tetragon.TracingPolicyDomain
	11, // 7: tetragon.ListTracingPoliciesResponse.policies:type_name -> tetragon.TracingPolicyStatus
	0,  // 8: tetragon.AddTracingPolicyRequest.domain:type_name -> tetragon.TracingPolicyDomain
	0,  // 9: tetragon.DeleteTracingPolicyRequest.domain:type_name -> tetragon.TracingPolicyDomain
	0,  // 10: tetragon.EnableTracingPolicyRequest.domain:type_name -> tetragon.TracingPolicyDomain
	0,  // 11: tetragon.DisableTracingPolicyRequest.domain:type_name -> tetragon.TracingPolicyDomain
	2,  // 12: tetragon.ConfigureTracingPolicyRequest.mode:type_name -> tetragon.TracingPolicyMode
	0,  // 13: tetragon.ConfigureTracingPolicyRequest.domain:type_name -> tetragon.TracingPolicyDomain
	0,  // 14: tetragon.ListDomainsResponse.domains:type_name -> tetragon.TracingPolicyDomain
	42, // 15: tetragon.GetInfoResponse.probes:type_name -> tetragon.GetInfoResponse.Probe
	43, // 16: tetragon.GetInfoResponse.conf:type_name -> tetragon.GetInfoResponse.ConfVal
	44, // 17: tetragon.GetInfoResponse.build:type_name -> tetragon.GetInfoResponse.BuildInfo
	46, // 18: tetragon.ProcessInternal.process:type_name -> tetragon.Process
	47, // 19: tetragon.ProcessInternal.refcnt:type_name -> google.protobuf.UInt32Value
	45, // 20: tetragon.ProcessInternal.refcnt_ops:type_name -> tetragon.ProcessInternal.RefcntOpsEntry
	36, // 21: tetragon.DumpProcessCacheResArgs.processes:type_name -> tetragon.ProcessInternal
	3,  // 22: tetragon.GetDebugRequest.flag:type_name -> tetragon.ConfigFlag
	35, // 23: tetragon.GetDebugRequest.dump:type_name -> tetragon.DumpProcessCacheReqArgs
	3,  // 24: tetragon.GetDebugResponse.flag:type_name -> tetragon.ConfigFlag
	4,  // 25: tetragon.GetDebugResponse.level:type_name -> tetragon.LogLevel
	37, // 26: tetragon.GetDebugResponse.processes:type_name -> tetragon.DumpProcessCacheResArgs
	3,  // 27: tetragon.SetDebugRequest.flag:type_name -> tetragon.ConfigFlag
	4,  // 28: tetragon.SetDebugRequest.level:type_name -> tetragon.LogLevel
	3,  // 29: tetragon.SetDebugResponse.flag:type_name -> tetragon.ConfigFlag
	4,  // 30: tetragon.SetDebugResponse.level:type_name -> tetragon.LogLevel
	48, // 31: tetragon.GetInfoResponse.Probe.Enabled:type_name -> google.protobuf.BoolValue
	49, // 32: tetragon.GetInfoResponse.ConfVal.value:type_name -> google.protobuf.Any
	50, // 33: tetragon.FineGuidanceSensors.GetEvents:input_type -> tetragon.GetEventsRequest
	51, // 34: tetragon.FineGuidanceSensors.GetHealth:input_type -> tetragon.GetHealthStatusRequest
	13, // 35: tetragon.FineGuidanceSensors.AddTracingPolicy:input_type -> tetragon.AddTracingPolicyRequest
	15, // 36: tetragon.FineGuidanceSensors.DeleteTracingPolicy:input_type -> tetragon.DeleteTracingPolicyRequest
	8,  // 37: tetragon.FineGuidanceSensors.ListTracingPolicies:input_type -> tetragon.ListTracingPoliciesRequest
	21, // 38: tetragon.FineGuidanceSensors.ConfigureTracingPolicy:input_type -> tetragon.ConfigureTracingPolicyRequest
	17, // 39: tetragon.FineGuidanceSensors.EnableTracingPolicy:input_type -> tetragon.EnableTracingPolicyRequest
	19, // 40: tetragon.FineGuidanceSensors.DisableTracingPolicy:input_type -> tetragon.DisableTracingPolicyRequest
	5,  // 41: tetragon.FineGuidanceSensors.ListSensors:input_type -> tetragon.ListSensorsRequest
	25, // 42: tetragon.FineGuidanceSensors.EnableSensor:input_type -> tetragon.EnableSensorRequest
	27, // 43: tetragon.FineGuidanceSensors.DisableSensor:input_type -> tetragon.DisableSensorRequest
	23, // 44: tetragon.FineGuidanceSensors.RemoveSensor:input_type -> tetragon.RemoveSensorRequest
	29, // 45: tetragon.FineGuidanceSensors.ListDomains:input_type -> tetragon.ListDomainsRequest
	31, // 46: tetragon.FineGuidanceSensors.GetVersion:input_type -> tetragon.GetVersionRequest
	33, // 47: tetragon.FineGuidanceSensors.GetInfo:input_type -> tetragon.GetInfoRequest
	52, // 48: tetragon.FineGuidanceSensors.RuntimeHook:input_type -> tetragon.RuntimeHookRequest
	38, // 49: tetragon.FineGuidanceSensors.GetDebug:input_type -> tetragon.GetDebugRequest
	40, // 50: tetragon.FineGuidanceSensors.SetDebug:input_type -> tetragon.SetDebugRequest
	53, // 51: tetragon.FineGuidanceSensors.GetEvents:output_type -> tetragon.GetEventsResponse
	54, // 52: tetragon.FineGuidanceSensors.GetHealth:output_type -> tetragon.GetHealthStatusResponse
	14, // 53: tetragon.FineGuidanceSensors.AddTracingPolicy:output_type -> tetragon.AddTracingPolicyResponse
	16, // 54: tetragon.FineGuidanceSensors.DeleteTracingPolicy:output_type -> tetragon.DeleteTracingPolicyResponse
	12, // 55: tetragon.FineGuidanceSensors.ListTracingPolicies:output_type -> tetragon.ListTracingPoliciesResponse
	22, // 56: tetragon.FineGuidanceSensors.ConfigureTracingPolicy:output_type -> tetragon.ConfigureTracingPolicyResponse
	18, // 57: tetragon.FineGuidanceSensors.EnableTracingPolicy:output_type -> tetragon.EnableTracingPolicyResponse
	20, // 58: tetragon.FineGuidanceSensors.DisableTracingPolicy:output_type -> tetragon.DisableTracingPolicyResponse
	7,  // 59: tetragon.FineGuidanceSensors.ListSensors:output_type -> tetragon.ListSensorsResponse
	26, // 60: tetragon.FineGuidanceSensors.EnableSensor:output_type -> tetragon.EnableSensorResponse
	28, // 61: tetragon.FineGuidanceSensors.DisableSensor:output_type -> tetragon.DisableSensorResponse
	24, // 62: tetragon.FineGuidanceSensors.RemoveSensor:output_type -> tetragon.RemoveSensorResponse
	30, // 63: tetragon.FineGuidanceSensors.ListDomains:output_type -> tetragon.ListDomainsResponse
	32, // 64: tetragon.FineGuidanceSensors.GetVersion:output_type -> tetragon.GetVersionResponse
	34, // 65: tetragon.FineGuidanceSensors.GetInfo:output_type -> tetragon.GetInfoResponse
	55, // 66: tetragon.FineGuidanceSensors.RuntimeHook:output_type -> tetragon.RuntimeHookResponse
	39, // 67: tetragon.FineGuidanceSensors.GetDebug:output_type -> tetragon.GetDebugResponse
	41, // 68: tetragon.FineGuidanceSensors.SetDebug:output_type -> tetragon.SetDebugResponse
