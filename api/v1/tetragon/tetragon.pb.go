...
func (x *ProcessBinary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcessBinary) ProtoMessage() {}

func (x *ProcessBinary) ProtoReflect() protoreflect.Message {
	mi := &file_tetragon_tetragon_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcessBinary.ProtoReflect.Descriptor instead.
func (*ProcessBinary) Descriptor() ([]byte, []int) {
	return file_tetragon_tetragon_proto_rawDescGZIP(), []int{27}
}

func (x *ProcessBinary) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *ProcessBinary) GetBuildid() []byte {
	if x != nil {
		return x.Buildid
	}
	return nil
...
type ProcessLoader struct {
	...
	Process *Process         `protobuf:"bytes,1,opt,name=process,proto3" json:"process,omitempty"`
	Parent  *Process         `protobuf:"bytes,2,opt,name=parent,proto3" json:"parent,omitempty"`
	Binary  []*ProcessBinary `protobuf:"bytes,3,rep,name=binary,proto3" json:"binary,omitempty"`
}
...
func (x *ProcessLoader) GetBinary() []*ProcessBinary {
	if x != nil {
		return x.Binary
	}
	return nil
...
var file_tetragon_tetragon_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x22, 0x3d, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x42, 0x69,
	0x6e, 0x61, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x62, 0x75, 0x69, 0x6c, 0x64,
	0x69, 0x64, 0x22, 0x98, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f,
	...
	0x63, 0x65, 0x73, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x06,
	0x62, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74,
	0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x42,
	0x69, 0x6e, 0x61, 0x72, 0x79, 0x52, 0x06, 0x62, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x2a, 0x83, 0x02,
...
var file_tetragon_tetragon_proto_depIdxs = []int32{
	...
	9,  // 61: tetragon.ProcessLoader.process:type_name -> tetragon.Process
	9,  // 62: tetragon.ProcessLoader.parent:type_name -> tetragon.Process
	30, // 63: tetragon.ProcessLoader.binary:type_name -> tetragon.ProcessBinary
