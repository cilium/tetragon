 ...
 */
FUNC_INLINE __nobuiltin("memcmp") __u64 memcmp(const void *x,
							  const void *y,
							  __u64 len)
{
...
FUNC_INLINE void __bpf_memmove_fwd(void *d, const void *s, __u64 len)
{
	if (!__builtin_constant_p(len))
		__throw_build_bug();
...
FUNC_INLINE __nobuiltin("memmove") void memmove(void *d,
							   const void *s,
							   __u64 len)
{
