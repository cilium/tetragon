...
int generic_usdt_process_filter_2(void *ctx);
...
struct {
	...
	.values = {
		...
		[TAIL_CALL_FILTER_2] = (void *)&generic_usdt_process_filter_2,
...
generic_usdt_process_filter(void *ctx)
{
	return generic_process_filter_stage(ctx, GENERIC_FILTER_STAGE_1,
					    ...
					    (struct bpf_map_def *)&usdt_calls);
}

__attribute__((section(COMMON), used)) int
generic_usdt_process_filter_2(void *ctx)
{
