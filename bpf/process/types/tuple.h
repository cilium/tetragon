...
// Returns the 32-bit IPv4 address in host byte order (matching LPM trie key format)
// On little-endian: addr[1] has format 0xDDCCBBAA_FFFF0000, we extract 0xDDCCBBAA
