...
func main() {
	...
	cmd.Flags().StringVar(&rcnf.testerConf.PolicyTestsFile, "policytests", vmtests.POLICY_TEST_ALL, "policy tests to run: 'all' or a path to a file with test names (one per line)")
