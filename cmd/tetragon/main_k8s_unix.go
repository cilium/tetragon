...
func EnableUprobeResolvePathInContainer(src events.PodEventSource, listPods func() ([]*corev1.Pod, error)) error {
	if err := tracing.RegisterResolvePathInContainerPodHandlers(src, listPods); err != nil {
