...
var file_tetragon_events_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x9e, 0x07, 0x0a,
	...
	0x6d, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x4a, 0x04, 0x08, 0x02, 0x10,
...
var file_tetragon_events_proto_goTypes = []any{
	...
	(*ProcessUsdt)(nil),           // 25: tetragon.ProcessUsdt
...
var file_tetragon_events_proto_depIdxs = []int32{
	...
	14, // 3: tetragon.Filter.in_init_tree:type_name -> google.protobuf.BoolValue
	...
	15, // 7: tetragon.CapFilterSet.any:type_name -> tetragon.CapabilitiesType
	15, // 8: tetragon.CapFilterSet.all:type_name -> tetragon.CapabilitiesType
	15, // 9: tetragon.CapFilterSet.exactly:type_name -> tetragon.CapabilitiesType
	15, // 10: tetragon.CapFilterSet.none:type_name -> tetragon.CapabilitiesType
	...
	16, // 13: tetragon.FieldFilter.fields:type_name -> google.protobuf.FieldMask
	1,  // 14: tetragon.FieldFilter.action:type_name -> tetragon.FieldFilterAction
	14, // 15: tetragon.FieldFilter.invert_event_set:type_name -> google.protobuf.BoolValue
	...
	17, // 20: tetragon.AggregationOptions.window_size:type_name -> google.protobuf.Duration
	2,  // 21: tetragon.ProcessThrottle.type:type_name -> tetragon.ThrottleType
	18, // 22: tetragon.GetEventsResponse.process_exec:type_name -> tetragon.ProcessExec
	19, // 23: tetragon.GetEventsResponse.process_exit:type_name -> tetragon.ProcessExit
	20, // 24: tetragon.GetEventsResponse.process_kprobe:type_name -> tetragon.ProcessKprobe
	21, // 25: tetragon.GetEventsResponse.process_tracepoint:type_name -> tetragon.ProcessTracepoint
	22, // 26: tetragon.GetEventsResponse.process_loader:type_name -> tetragon.ProcessLoader
	23, // 27: tetragon.GetEventsResponse.process_uprobe:type_name -> tetragon.ProcessUprobe
	12, // 28: tetragon.GetEventsResponse.process_throttle:type_name -> tetragon.ProcessThrottle
	24, // 29: tetragon.GetEventsResponse.process_lsm:type_name -> tetragon.ProcessLsm
	25, // 30: tetragon.GetEventsResponse.process_usdt:type_name -> tetragon.ProcessUsdt
	26, // 31: tetragon.GetEventsResponse.test:type_name -> tetragon.Test
	11, // 32: tetragon.GetEventsResponse.rate_limit_info:type_name -> tetragon.RateLimitInfo
	27, // 33: tetragon.GetEventsResponse.time:type_name -> google.protobuf.Timestamp
