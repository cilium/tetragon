...
For further community-maintained policy examples, refer to the [policy examples directory](https://github.com/cilium/tetragon/tree/main/policies) on GitHub. These examples are valid policies used in the entire documentation and provided by the community  but they are not curated in terms of suitability for specific use cases or best practices.
