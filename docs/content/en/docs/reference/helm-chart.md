...
| tetragon.image.tag | string | `"v1.6.0-rc.1"` |  |
...
| tetragonOperator.image | object | `{"override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/tetragon-operator","tag":"v1.6.0-rc.1"}` | tetragon-operator image. |
