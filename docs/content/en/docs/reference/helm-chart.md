...
| tetragon.image.tag | string | `"v1.0.2"` |  |
...
| tetragonOperator.image | object | `{"override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/tetragon-operator","tag":"v1.0.2"}` | tetragon-operator image. |
