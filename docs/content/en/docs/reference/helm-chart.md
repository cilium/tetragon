...
| tetragon.securityContext.capabilities.add[0] | string | `"SYS_ADMIN"` |  |
| tetragon.securityContext.capabilities.add[1] | string | `"SYS_PTRACE"` |  |
| tetragon.securityContext.capabilities.add[2] | string | `"SYS_RESOURCE"` |  |
| tetragon.securityContext.capabilities.add[3] | string | `"DAC_OVERRIDE"` |  |
| tetragon.securityContext.capabilities.add[4] | string | `"SYSLOG"` |  |
