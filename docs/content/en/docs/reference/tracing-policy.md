    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td>
          ...
          <br/>
            <i>Validations</i>:<li>!has(self.uprobes) || !self.uprobes.exists(u, u.resolvePathInContainer) || has(self.podSelector): uprobe resolvePathInContainer requires a podSelector</li><li>!has(self.uprobes) || !self.uprobes.exists(u, u.resolvePathInContainer) || !has(self.hostSelector): uprobe resolvePathInContainer cannot be combined with a hostSelector</li>
        </td>
        <td>true</td>
      </tr></tbody>
</table>
