...
{{< warning >}}
Beware, these examples are not production-ready. They were intended to be consumed as a reference for the aforementioned book.
The examples are not guaranteed to work as-is. Please do not treat them as documentation.
{{< /warning >}}