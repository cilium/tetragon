...
![Version: 1.0.0-rc.4](https://img.shields.io/badge/Version-1.0.0--rc.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0-rc.4](https://img.shields.io/badge/AppVersion-1.0.0--rc.4-informational?style=flat-square)
...
| tetragon.image.tag | string | `"v1.0.0-rc.4"` |  |
...
| tetragonOperator.image | object | `{"override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/tetragon-operator","suffix":"","tag":"v1.0.0-rc.4"}` | tetragon-operator image. |
