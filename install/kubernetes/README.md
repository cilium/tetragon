...
| tetragon.image.tag | string | `"v0.8.2"` |  |
...
| tetragonOperator.image | object | `{"override":null,"repository":"quay.io/cilium/tetragon-operator","suffix":"","tag":"v0.8.2"}` | tetragon-operator image. |
