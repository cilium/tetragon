...
// CheckStructAlignmentsDefault checks whether size and offsets of the C and Go
...
func CheckStructAlignmentsDefault(pathToObj string) error {
	...
	return CheckStructAlignments(pathToObj, alignments, true)
}

// CheckStructAlignmentsWithChecks checks whether size and offsets match of the given
