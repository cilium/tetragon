...
type TetragonConf struct {
	...
	PID                uint32 `align:"pid"`                   // Tetragon PID
	NSPID              uint32 `align:"nspid"`                 // Tetragon PID in namespace
	TgCgrpHierarchy    uint32 `align:"tg_cgrp_hierarchy"`     // Tetragon Cgroup tracking hierarchy
	TgCgrpHierarchyIdx uint32 `align:"tg_cgrp_hierarchy_idx"` // Tracking Cgroup hierarchy idx at compile time
