...
func detectUprobeRegsChange() bool {
	prog, err := ebpf.NewProgram(&ebpf.ProgramSpec{
		...
		Type: ebpf.Kprobe,
		Instructions: asm.Instructions{
			asm.StoreImm(asm.R1, 0x0 /* change first register in context */, 0xdead, 8),
			asm.Mov.Imm(asm.R0, 0),
			asm.Return(),
		},
		License: "MIT",
...
var FeatureProbes = []FeatureProbe{
	...
	{SignalHelperProbe, HasSignalHelper},
	{LargeProgsProbe, HasProgramLargeSize},
	{LinkPinProbe, HasLinkPin},
	{LsmProbe, HasLSMPrograms},
	{MissedStatsKprobeMultiProbe, HasMissedStatsKprobeMulti},
	{MissedStatsKprobeProbe, HasMissedStatsPerfEvent},
	{BatchUpdateProbe, HasBatchAPI},
	{UprobeRefCtrOffsetProbe, HasUprobeRefCtrOffset},
