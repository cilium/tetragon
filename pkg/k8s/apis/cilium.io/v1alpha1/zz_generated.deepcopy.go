...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredIDValues) DeepCopyInto(out *CredIDValues) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredIDValues.
func (in *CredIDValues) DeepCopy() *CredIDValues {
	if in == nil {
		return nil
	}
	out := new(CredIDValues)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredentialsSelector) DeepCopyInto(out *CredentialsSelector) {
	*out = *in
	if in.RUIDs != nil {
		in, out := &in.RUIDs, &out.RUIDs
		*out = make([]CredIDValues, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.EUIDs != nil {
		in, out := &in.EUIDs, &out.EUIDs
		*out = make([]CredIDValues, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredentialsSelector.
func (in *CredentialsSelector) DeepCopy() *CredentialsSelector {
	if in == nil {
		return nil
	}
	out := new(CredentialsSelector)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KProbeSelector) DeepCopyInto(out *KProbeSelector) {
	*out = *in
	...
	if in.MatchCurrentCred != nil {
		in, out := &in.MatchCurrentCred, &out.MatchCurrentCred
		*out = make([]CredentialsSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
