...
func (in *PodInfoStatus) DeepCopyInto(out *PodInfoStatus) {
	*out = *in
	...
	out.TopLevelWorkload = in.TopLevelWorkload
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopLevelWorkload) DeepCopyInto(out *TopLevelWorkload) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopLevelWorkload.
func (in *TopLevelWorkload) DeepCopy() *TopLevelWorkload {
	if in == nil {
		return nil
	}
	out := new(TopLevelWorkload)
	in.DeepCopyInto(out)
	return out
}
