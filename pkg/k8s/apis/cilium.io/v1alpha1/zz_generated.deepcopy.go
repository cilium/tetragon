...
func (in *KProbeSelector) DeepCopyInto(out *KProbeSelector) {
	*out = *in
	...
	if in.MatchLoginUids != nil {
		in, out := &in.MatchLoginUids, &out.MatchLoginUids
		*out = make([]LoginUidSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoginUidSelector) DeepCopyInto(out *LoginUidSelector) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoginUidSelector.
func (in *LoginUidSelector) DeepCopy() *LoginUidSelector {
	if in == nil {
		return nil
	}
	out := new(LoginUidSelector)
	in.DeepCopyInto(out)
	return out
}
