...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsdtName) DeepCopyInto(out *UsdtName) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsdtName.
func (in *UsdtName) DeepCopy() *UsdtName {
	if in == nil {
		return nil
	}
	out := new(UsdtName)
