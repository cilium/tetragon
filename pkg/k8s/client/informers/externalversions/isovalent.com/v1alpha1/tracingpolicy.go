...
import (
	...
	isovalentcomv1alpha1 "github.com/isovalent/tetragon-oss/pkg/k8s/apis/isovalent.com/v1alpha1"
	...
	v1alpha1 "github.com/isovalent/tetragon-oss/pkg/k8s/client/listers/isovalent.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IsovalentV1alpha1().TracingPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IsovalentV1alpha1().TracingPolicies().Watch(context.TODO(), options)
			},
		},
		&isovalentcomv1alpha1.TracingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tracingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&isovalentcomv1alpha1.TracingPolicy{}, f.defaultInformer)
}
