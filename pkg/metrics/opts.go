...
//
// The resulting labels will follow the order:
// 1. FilteredLabels passed via type parameter (assumed to be unconstrained)
// 2. constrained labels passed via opts
// 3. unconstrained labels passed via opts
//
// The constrained labels will be enforced by the prometheus library and
// replaced with an empty string if a value outside of the list is passed.
