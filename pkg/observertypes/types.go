...
// Package observertypes defines interfaces for the observer subsystem.
// This package exists to break circular dependencies between observer and synthetic packages.
package observertypes
