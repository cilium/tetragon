...
func (f *fakePodEventSource) OnPodAdd(handler func(pod *v1.Pod)) error {
	f.addHandlers = append(f.addHandlers, handler)
	return nil
}

func (f *fakePodEventSource) OnPodUpdate(handler func(oldPod, newPod *v1.Pod)) error {
	f.updateHandlers = append(f.updateHandlers, handler)
	return nil
}

func (f *fakePodEventSource) OnPodDelete(handler func(pod *v1.Pod)) error {
...
func TestK8s(t *testing.T) {
	...
	require.NoError(t, st.RegisterPodHandlers(source))
