...
type KernelSelectorData struct {
	off uint32 // offset into encoding (== len(e))
	e   []byte // kernel encoding of selectors, grows as selectors are encoded
}
...
func (k *KernelSelectorState) Buffer() [KernelBufferSize]byte {
