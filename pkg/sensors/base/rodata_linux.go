...
// MapBuilderRodataConfig builds Tetragon's own shared, read-only rodata
// configuration map, wired to the given program load descriptors.
func MapBuilderRodataConfig(lds ...*program.Program) *program.Map {
	return program.MapBuilderRodataConfig(rodataConfigMap, rodataConfigPin,
...
var RodataConfigMap = MapBuilderRodataConfig(Execve)
