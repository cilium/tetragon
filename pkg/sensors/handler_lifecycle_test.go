...
func (s *orderedLifecycleSensor) HookStatus() []*tetragon.HookStatus { return nil }
func (s *orderedLifecycleSensor) IsEmpty() bool                      { return false }
...
func (s *callbackDestroySensor) HookStatus() []*tetragon.HookStatus { return nil }
func (s *callbackDestroySensor) IsEmpty() bool                      { return false }
...
func (s *reentrantDestroySensor) HookStatus() []*tetragon.HookStatus { return nil }
func (s *reentrantDestroySensor) IsEmpty() bool                      { return false }
