...
func (s *Server) DumpProcessLRU(_ context.Context, req *tetragon.DumpProcessLRURequest) (*tetragon.DumpProcessLRUResponse, error) {
	return &tetragon.DumpProcessLRUResponse{
		Processes: process.DumpProcessLRU(req),
	}, nil
}
