...
// TestReconciler_PredicateBehavior asserts the four key behaviors documented
// in the issue for both Reconciler implementations: create -> Add; status /
// annotation patch -> silent; spec mutate -> Delete+Add; delete -> Delete.
//
