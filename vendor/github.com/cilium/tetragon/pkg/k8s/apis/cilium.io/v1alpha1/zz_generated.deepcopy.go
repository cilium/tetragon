...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericBinarySelector) DeepCopyInto(out *GenericBinarySelector) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericBinarySelector.
func (in *GenericBinarySelector) DeepCopy() *GenericBinarySelector {
	if in == nil {
		return nil
	}
	out := new(GenericBinarySelector)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KProbeSelector) DeepCopyInto(out *KProbeSelector) {
	*out = *in
	...
	if in.MatchBinaries != nil {
		...
		*out = make([]GenericBinarySelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
